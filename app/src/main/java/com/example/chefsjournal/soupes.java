...
public class soupes extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = inflater.inflate(R.layout.fragment_soupes, container, false);

        recyclerView = view.findViewById(R.id.recyclerViewSoupes);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

        recetteList = new ArrayList<>();
        recetteList.add(new Recette("soupe", "Ahmet", R.drawable.soupe));
        recetteList.add(new Recette("salade", "yassin", R.drawable.salade));
